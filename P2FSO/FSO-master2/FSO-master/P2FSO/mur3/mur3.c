...
int main(int n_args, char *ll_args[])
{
	...
	int id_f_pil, id_c_pil, id_pos_c, id_pos_f, id_vel_f, id_vel_c, id_xoc;
	int *p_f_pil, *p_c_pil, *p_pos_c, *p_pos_f, *p_vel_f, *p_vel_c, *p_xoc;
	...
	*p_c_pil = c_pil[0]; /* inicialitza variable compartida */
	...
	//////
	id_pos_c = ini_mem(sizeof(int)); /* crear zona mem. compartida */
	p_pos_c = map_mem(id_pos_c); /* obtenir adreça mem. compartida */
	*p_pos_c = pos_c[0]; /* inicialitza variable compartida */
	sprintf(a3,"%i",id_pos_c); /* convertir id. memoria en string */
	//////
	id_pos_f = ini_mem(sizeof(int)); /* crear zona mem. compartida */
	p_pos_f = map_mem(id_pos_f); /* obtenir adreça mem. compartida */
	*p_pos_f = pos_f[0]; /* inicialitza variable compartida */
	sprintf(a4,"%i",id_pos_f); /* convertir id. memoria en string */
	//////
	id_vel_f = ini_mem(sizeof(int)); /* crear zona mem. compartida */
	p_vel_f = map_mem(id_vel_f); /* obtenir adreça mem. compartida */
	*p_vel_f = vel_f[0]; /* inicialitza variable compartida */
	sprintf(a5,"%i",id_vel_f); /* convertir id. memoria en string */
	//////
	id_vel_c = ini_mem(sizeof(int)); /* crear zona mem. compartida */
	p_vel_c = map_mem(id_vel_c); /* obtenir adreça mem. compartida */
	*p_vel_c = vel_c[0]; /* inicialitza variable compartida */
	sprintf(a6,"%i",id_vel_c); /* convertir id. memoria en string */
	//////
	id_xoc = ini_mem(sizeof(int)); /* crear zona mem. compartida */
	p_xoc = map_mem(id_xoc); /* obtenir adreça mem. compartida */
	*p_xoc = xocBlock[0]; /* inicialitza variable compartida */
	sprintf(a7,"%i",id_xoc); /* convertir id. memoria en string */
	//////

	tpid[0] = fork();//crea procés pilota
	...
	a7 -> index
	*/
	execlp("./pilota", "pilota", a1, a2, a3, a4, a5, a6, a7, (char*) 0);//(char*) 0 actua com a sentinella
