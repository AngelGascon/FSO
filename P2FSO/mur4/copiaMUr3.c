...
int main(int n_args, char *ll_args[])
{
	...
	int id_n_col, id_fiPala, id_fiPilota, id_retard;
	int *p_n_col, *p_fiPala, *p_fiPilota, *p_retard;
	...
	*p_tecla = tecla; /* inicialitza variable compartida */
	...
	/////
	id_n_col = ini_mem(sizeof(n_col)); /* crear zona mem. compartida */
	p_n_col = map_mem(id_n_col); /* obtenir adreça mem. compartida */
	*p_n_col = n_col; /* inicialitza variable compartida */
	sprintf(a6,"%i",id_n_col); /* convertir id. memoria en string */
	//////
	id_fiPala = ini_mem(sizeof(fiPala)); /* crear zona mem. compartida */
	p_fiPala = map_mem(id_fiPala); /* obtenir adreça mem. compartida */
	*p_fiPala = fiPala; /* inicialitza variable compartida */
	sprintf(a7,"%i",id_fiPala); /* convertir id. memoria en string */
	//////
	id_fiPilota = ini_mem(sizeof(fiPilota)); /* crear zona mem. compartida */
	p_fiPilota = map_mem(id_fiPilota); /* obtenir adreça mem. compartida */
	*p_fiPilota = fiPilota; /* inicialitza variable compartida */
	sprintf(a8,"%i",id_fiPilota); /* convertir id. memoria en string */
	//////
	id_retard = ini_mem(sizeof(retard)); /* crear zona mem. compartida */
	p_retard = map_mem(id_retard); /* obtenir adreça mem. compartida */
	*p_retard = retard; /* inicialitza variable compartida */
	sprintf(a9,"%i",id_retard); /* convertir id. memoria en string */

	tpid[0] = fork();//crea procés pala
	// a1=fpal,a2=cpal,a3=mpal,a4=dirPaleta,a5=tecla, a6=n_col, a7=fiPala, a8=fiPilota, a9=retard
	execlp("./pala", "pala", a1, a2, a3, a4, a5, a6, a7, a8, a9, (char*) 0);//(char*) 0 actua com a sentinella
